...
ZaneOps may work properly on servers with lower specs than those mentioned above, but we recommend slightly higher requirements.
...
you might need a bigger server, if you want to host static sites though, these requirements might totally be enough.
