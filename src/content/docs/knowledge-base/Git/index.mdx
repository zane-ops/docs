...
Using Git apps, you can deploy private repositories with automatic deploys on Git push.
...
Keep in mind that using the repository URL, auto-deploy on Git push are not available.
