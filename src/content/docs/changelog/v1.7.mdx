...
Starting from [v1.7.0](https://github.com/zane-ops/zane-ops/releases/tag/v1.7.0), for all upgrades all future versions you will
get a toast indicating you of newly available versions of ZaneOps, allowing you to upgrade ZaneOps directly from the UI instead of the terminal only :
