...
You can also check out our example tutorials on deploying applications with ZaneOps:  
...
Thanks to our main contributors [@mo-cherif](//github.com/mo-cherif) and [@fredkiss3](//github.com/frekdiss3) for making v1 possible.  

We also want to thank these projects for their inspiration:  
