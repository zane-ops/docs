...
<video muted src="/videos/deploy-using-docker.mp4" alt="Deploy using Docker" controls />  

### Environment Variables Management  

Supports adding single variables:  

<video muted src="/videos/add-env-variables.mp4" alt="Add environment variables" controls />  

And importing variables from `.env` files:  

<video muted src="/videos/add-from-dotenv.mp4" alt="Import from .env files" controls />  

### Advanced URL Management  

Supports wildcard domains:  

<video muted src="/videos/wildcard-support.mp4" alt="Wildcard domain support" controls />  

Generates default URLs for services:  

<video muted src="/videos/generate-url.mp4" alt="Generate default URLs" controls />  
...
<video muted src="/videos/application-logs.mp4" alt="Application logs per deployment" controls />  

HTTP logs are persisted per deployment and per service:  

<video muted src="/videos/http-logs.mp4" alt="HTTP logs per service" controls />  

### Monitoring  

Provides metrics per service and deployment:  

<video muted src="/videos/metrics.mp4" alt="Service and deployment metrics" controls />  

### Git-Like Configuration Changes  

Allows you to review changes before deploying:  

<video muted src="/videos/changes-modal.mp4" alt="Review changes before deployment" controls />  

### Resource Limits  

<video muted src="/videos/resource-limits.mp4" alt="Set resource limits" controls />  

### Magic File Mounts  

Override the content of any file within your services or add new files required for configuration:  

<video muted src="/videos/config-files.mp4" alt="Magic file mounts for configuration" controls />  

### Deployment Webhook URLs  

Easily set up a [CI/CD workflow](/deploying-with-github-actions):  

<video muted src="/videos/deploy-webhook-url.mp4" alt="Deployment webhook URL" controls />  
