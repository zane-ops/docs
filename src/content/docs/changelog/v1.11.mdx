...
In this version we added support for private GitHub and GitLab repositories. This 
is done via [Git apps](/knowledge-base/git-apps). You can create and install a git app either on your GitHub or GitLab profile.
