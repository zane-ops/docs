...
Today we release zaneOps v1.8 introducing our all new [Git services](#git-services). 
...
<img className="block dark:hidden" src="/images/create-git-service-light.png" alt="Creating a git service" />
<img className="!hidden dark:!block" src="/images/create-git-service-dark.png" alt="Creating a git service" />
