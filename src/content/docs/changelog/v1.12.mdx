...
The major feature for this version is preview environments. They allow you to test a feature in 
a branch or pull request on your app before merging to production. 

For services created via Git applications, Pull request preview environments are activated by default, 
