...
<img className="block dark:hidden" src="https://assets.zaneops.dev/images/dashboard-light.png" alt="Dashboard page" />
<img className="!hidden dark:!block" src="https://assets.zaneops.dev/images/dashboard-dark.png" alt="Dashboard page" />
