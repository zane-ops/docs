...
ZaneOps is designed to operate on a variety of environments. For optimal performance, we recommend the following specifications :

- **Minimum Requirements** (Shared vCPU)
    - **vCPUs:** 2 (x86 or Arm64)
    - **RAM:** 4 GB
    - **Disk:** 40 GB
- **Recommended Requirements** (Dedicated vCPU)
    - **vCPUs:** 4 (x86 or Arm64)
    - **RAM:** 8 GB
    - **Disk:** 80 GB
